...
Style: Default,Arial,20,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,0,0,1,1,1,1,10,10,10,0\n\
\n\
[Events]\n\
...
static int write_subtitle_file_header(struct encoder_ctx *ctx, struct ccx_s_write *out)
{
	...
	switch (ctx->write_format)
	{
		...
		case CCX_OF_SSA:
			...
			memcpy(shared_subtitles + shared_subtitles_size, ctx->buffer, used);
